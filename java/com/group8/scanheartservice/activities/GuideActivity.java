...
public class GuideActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.viewpaper_page2, null));
        pageViews.add(inflater.inflate(R.layout.viewpaper_page3, null));
        pageViews.add(inflater.inflate(R.layout.activity_login, null));
    ...
    class GuidePageAdapter extends PagerAdapter{
        ...
        public Object instantiateItem(View v, int position) {
            ...
            // 测试页卡1内的按钮事件
            if (position == 2) {
                ImageButton btn = (ImageButton) v.findViewById(R.id.btn_close_guide);
